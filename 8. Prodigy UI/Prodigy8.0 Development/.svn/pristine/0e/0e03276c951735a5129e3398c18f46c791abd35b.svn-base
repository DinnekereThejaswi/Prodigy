    ...
    var uiFreezeCoordinator = {
        ...
        _saveFreezeItemsInitialState: function (freezeItemsContainerID) {
            ...
            for (var index = 0; index < $allFreezeItems.length; index++) {
                ...
                var itemBounds = rectangle(itemPosition.left, itemPosition.top, $item.outerWidth(true), $item.outerHeight(true));
                ...
                this._saveFreezeItemInitialState(freezeItemsContainerID, $item, itemID, itemPosition);
            }
        ...
        _updateFreezeItemsOnScroll: function (freezeItemsContainerID, scrollableContainerScrollTop, scrollableContainerScrollLeft) {
            ...
            if (this._isInScrollVisibleArea($elementWrapper)) {
                ...
                var pageContainerBorderWidth = parseFloat($pageContainer.css("border-width"));
                ...
                var elementWrapperTopPosition = elementWrapperPosition.top + pageContainerPosition.top + pageContainerMargin + pageContainerTopOffset + pageContainerBorderWidth;
                var elementWrapperLeftPosition = elementWrapperPosition.left + pageContainerLeftOffset + pageContainerBorderWidth;
                ...
                if (hasFixColumn && verticalMoveOffset > 0) {
                    if (scrollableContainerScrollTop <= $elementWrapper.outerHeight() + elementWrapperTopPosition - this.yFrozenAreasBounds[freezeItemsContainerID].height) {
                        this.currentlyfreezedContainer.vertical[freezeItemsContainerID] = true;
                        this._updateUIElementsPosition($colHeaders, "top", verticalMoveOffset, freezeItemsContainerID);
                    }
                } else {
                ...
                if (hasFixRow && horizontalMoveOffset > 0) {
                    if (scrollableContainerScrollLeft <= $elementWrapper.outerWidth() + elementWrapperLeftPosition - this.xFrozenAreasBounds[freezeItemsContainerID].width) {
                        this.currentlyfreezedContainer.horizontal[freezeItemsContainerID] = true;
                        this._updateUIElementsPosition($rowHeaders, "left", horizontalMoveOffset, freezeItemsContainerID);
                    }
                } else {
...
/* DO NOT MODIFY OR DELETE THIS LINE! UPGRADE WIZARD CHECKSUM 8609023FEE3BF79765191641BB3AF6A7 */