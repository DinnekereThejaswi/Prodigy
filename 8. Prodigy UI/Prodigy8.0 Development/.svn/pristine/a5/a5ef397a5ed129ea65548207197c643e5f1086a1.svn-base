...
@Component({
  selector: 'app-invoice-ship-label-generation',
  templateUrl: './invoice-ship-label-generation.component.html',
  styleUrls: ['./invoice-ship-label-generation.component.css']
})
export class InvoiceShipLabelGenerationComponent implements OnInit {
